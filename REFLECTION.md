Student: [Jo Yeong Wan wah] · Course: MGMT 6110 · Problem Set 1 User sentence: A [Relationship Manager in a Private Bank] opens this screen to [Monitor and Assess her client's portfolio balances and performance], and knows it worked when [she is able to view windows showing her customer's main financial product 360 profile dashboard, 5-year future potential trajectory of portfolio, RM's potential revenue of cross-selling products and insights to top competitors with market intelligence]. Live link: [https://mgmt-6110-week-1-assignment-jyww-v2.vercel.app/]
